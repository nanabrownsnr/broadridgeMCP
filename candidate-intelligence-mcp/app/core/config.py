...
def configure_logging() -> None:
    ...
    file_handler = TimedRotatingFileHandler("./logs/candidate-intelligence-mcp-api.log", when="midnight", interval=1, backupCount=7)
...
class Settings(BaseSettings):
    SERVICE_ID: str = "candidate_intelligence_mcp"
    APP_TITLE: str = "Candidate Intelligence MCP"
    ROOT_PATH: str = ""
    VERSION: str = "1.0"
    RELEASE_ID: str = "0.1"
