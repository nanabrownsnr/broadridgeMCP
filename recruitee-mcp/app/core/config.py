...
class Settings(BaseSettings):
    SERVICE_ID: str = "recruitee_mcp"
    APP_TITLE: str = "Recruitee MCP"
    ROOT_PATH: str = ""
    VERSION: str = "1.0"
    RELEASE_ID: str = "0.1"
    ...
    RECRUITEE_API_URL: str = "https://api.recruitee.com"
    RECRUITEE_API_KEY: str = ""
    RECRUITEE_COMPANY_ID: str = ""
    RECRUITEE_KEY_SERVICE_NAME: str = "Recruitee"
