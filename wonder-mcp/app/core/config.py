...
def configure_logging() -> None:
    ...
    file_handler = TimedRotatingFileHandler("./logs/wonder-mcp-api.log", when="midnight", interval=1, backupCount=7)
...
class Settings(BaseSettings):
    SERVICE_ID: str = "wonder_mcp"
    APP_TITLE: str = "Wonder MCP"
    ROOT_PATH: str = ""
    VERSION: str = "1.0"
    RELEASE_ID: str = "0.1"
    ...
    WONDER_API_URL: str = "https://api.wonder.design"
    WONDER_API_KEY: str = ""
    WONDER_KEY_SERVICE_NAME: str = "Wonder"
    WONDER_AUTH_SCHEME: str = "Bearer"
