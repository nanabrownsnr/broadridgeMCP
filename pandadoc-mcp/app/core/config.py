...
def configure_logging() -> None:
    ...
    file_handler = TimedRotatingFileHandler("./logs/pandadoc-mcp-api.log", when="midnight", interval=1, backupCount=7)
...
class Settings(BaseSettings):
    SERVICE_ID: str = "pandadoc_mcp"
    APP_TITLE: str = "PandaDoc MCP"
    ROOT_PATH: str = ""
    VERSION: str = "1.0"
    RELEASE_ID: str = "0.1"
    ...
    PANDADOC_API_URL: str = "https://api.pandadoc.com"
    PANDADOC_API_KEY: str = ""
    PANDADOC_KEY_SERVICE_NAME: str = "PandaDoc"
