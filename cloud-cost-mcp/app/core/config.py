...
def configure_logging() -> None:
    ...
    file_handler = TimedRotatingFileHandler("./logs/cloud-cost-mcp-api.log", when="midnight", interval=1, backupCount=7)
...
class Settings(BaseSettings):
    SERVICE_ID: str = "cloud_cost_mcp"
    APP_TITLE: str = "Cloud Cost MCP"
    ROOT_PATH: str = ""
    VERSION: str = "1.0"
    RELEASE_ID: str = "0.1"
    ...
    CLOUD_COST_KEY_SERVICE_NAME: str = "CloudCost"
    CLOUD_COST_CURRENCY: str = "USD"
    DEFAULT_MONTHLY_HOURS: int = 730
